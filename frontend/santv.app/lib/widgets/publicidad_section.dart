                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        neonColor.withValues(alpha: 0.45 + pulse * 0.15),
                        neonColor.withValues(alpha: 0.14 + pulse * 0.08),
                      ],
                    ),
                    border: Border.all(
                      color: neonColor.withValues(alpha: 0.4 + pulse * 0.35),
                      width: 1.2,
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: neonColor.withValues(alpha: 0.25 + pulse * 0.3),
